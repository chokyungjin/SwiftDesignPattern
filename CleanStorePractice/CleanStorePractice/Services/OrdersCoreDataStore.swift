...
class OrdersCoreDataStore: OrdersStoreProtocol, OrdersStoreUtilityProtocol
{
    ...
    // 관리 객체의 생성, 삭제, 편집, 질의 등을 수행하기 위해 NSManagedObjectContext와 통신
    ...
    init()
    {
        ...
        // 특정 확장자의 값 읽어오려면 Bundle.main.url사용, xcdatamodeld 의 확장자가 .momd..?
        guard let modelURL = Bundle.main.url(forResource: "CleanStorePractice", withExtension: "momd") else {
        ...
        // xcdatamodeld의 프로젝트 내 링크 주소로 값 가져옴
        
        let psc = NSPersistentStoreCoordinator(managedObjectModel: mom)
        // NSPersistentStoreCoordinator = 객체의 데이터를 실제로 저장하고 있는 실제 파일과 앱이 사용하는 객체 모델 사이를 중개한다.
         ...
         */
        let storeURL = docURL.appendingPathComponent("CleanStorePractice.sqlite")
        do {
